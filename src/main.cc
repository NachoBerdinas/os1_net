...
int main(int argc, char **argv){
    ...
    char* rutaVideo = NULL;
	char archivoConfiguracionWebcamPorDefecto[] = "/home/nacho/workspace/os1/webcamNacho.yaml";	// Configuración por defecto, para webcam.
    ...
    ORB_SLAM2::System SLAM("/home/nacho/workspace/os1/orbVoc.bin", rutaConfiguracion,ORB_SLAM2::System::MONOCULAR,true);
    ...
    while(true){
        ...
        if(video.imagenDisponible)
            ...
            if(SLAM.mpTracker->mState == 2 && hasInitialized){
                ...
                buffer << SLAM.mpTracker->mCurrentFrame.mTcw << std::endl;

                cout << buffer.str() << endl;
                tcid.sendLocation(buffer.str());
